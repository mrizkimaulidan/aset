<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="{{ request()->is('pengguna') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.pengguna.index') }}"><i class="fas fa-users"></i> <span>Data Pengguna</span></a></li>
    <li><a class="nav-link" href="blank.html"><i class="fas fa-th-large"></i> <span>Jenis Aset</span></a></li>
